...
const Profile: NextPage = () => {
  ...
  return (
    <BaseLayout>
    {/* {(window) ? <h1>Current User: {window.ethereum.selectedAddress}</h1> : <h1></h1>} */}
    {/* <h1>Current User: {window.ethereum.selectedAddress}</h1> */}
              ...
              <div className="pb-16 space-y-6">
                ...
                <div>
                  ...
                  <dl className="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                    {/* {console.log("attrs price: ", activeNft.price)} */}
                      {activeNft.meta.attributes.map((attr) => (
                        (activeNft.price != 0.00001) ?
                          ...
                          :
                          <div key={attr.degree_trait_type} className="py-3 flex justify-between text-sm font-medium">
                            <dt className="text-gray-500">{attr.degree_trait_type}: </dt>
                            <dd className="text-gray-900 text-right">{attr.value}</dd>
                          </div>
